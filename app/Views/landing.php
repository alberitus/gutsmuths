            ...
            <div class="row">
                <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1"
                    ...
                    <div class="d-flex justify-content-center justify-content-lg-start">
                        <a href="/pra" class="btn-get-started scrollto">Join Our Partner</a>
                        <a href="#about" class="btn-get-started scrollto"><i
                                class="bi bi-info"></i><span>About</span></a>
                    </div>
                </div>
                <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-in" data-aos-delay="200">
                    <img src="assets/images/logo.png" class="img-fluid animated" alt="">
                </div>
            </div>
        </div>
    ...
    <main id="main">
        ...
        <section id="join" class="join">
            <div class="container" data-aos="fade-up">
                ...
                <div class="row content">
                    <div class="col-lg-6" id="person" class="person">
                        <a href="#person" class="glightbox btn-learn-more">PERSONAL</a>
                        <p>
                    ...
                    <div class="col-lg-6 pt-4 pt-lg-0" id="organization" class="organization">
                    <a href="#organization" class="glightbox btn-learn-more">ORGANIZATION</a>
                        <p>
                            organization
                        </p>
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                        <div class="portfolio-img"><img src="assets/img/portfolio/botol.png" class="img-fluid"
                                alt=""></div>
                        <div class="portfolio-info">
                            <h4>App 1</h4>
                            <p>App</p>
                            <a href="assets/img/portfolio/botol.png" data-gallery="portfolioGallery"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6" data-aos="zoom-in" data-aos-delay="100">
                        <div class="member d-flex align-items-start">
                            <div class="pic"><img src="assets/img/nopict.jpg" class="img-fluid" alt=""></div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 d-flex align-items-stretch">
                        <div class="info">
                            ...
                            <div style="width: 100%"><iframe width="100%" height="450" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" 
                            src="https://maps.google.com/maps?width=100%25&amp;height=450&amp;hl=en&amp;q=Jl.%20Babarsari%20No.43,%20Janti,%20Caturtunggal,%20Kec.%20Depok,%20Kabupaten%20Sleman,%20Daerah%20Istimewa%20Yogyakarta%2055281+(Atma%20Jaya)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed">
                            <a href="https://www.gps.ie/">gps devices</a></iframe></div>
